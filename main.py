...
def main():
    ...
    app_mode = st.sidebar.selectbox("Choose the app mode",
                                   ["Main page","Data browser", "Make training set","Latent-View", "Build model", "Prediction"])
    st.sidebar.subheader("Select date range")
    start_date = st.sidebar.date_input("START DATE", value=datetime(2013,1,1))
    ...
    dataset_selected = copy.deepcopy(dataset)
